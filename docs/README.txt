...
----------
 ...
 - Restoring NG2 crushing gore effects (but only for Mages, TAC Ninjas, Wolves, and
   Chainsaw Fiend)
...
the game from Steam as written below after the installation:
