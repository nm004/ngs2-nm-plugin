...
init ()
{
  ...
  switch (image_id)
	...
	// so we inject the parameters re-ordering code in the beginning.
    	...
    	patch6 = new CallOffsetPatch {0x14152e7, 0x0c0fc40};
    	patch7 = new CallOffsetPatch {0x1415c65, 0x0c0fc40};
	...
	patch6 = new CallOffsetPatch {0x14150b7, 0x0c0fcb0};
	patch7 = new CallOffsetPatch {0x1415a35, 0x0c0fcb0};
